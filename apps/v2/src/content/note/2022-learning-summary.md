...
- [Spotify Teardown](/spotify-teardown/)

# [Devops](/devops/)

- [MTTR > MTBF](/mttr/) -  Optimising Mean Time To Recovery is more important than trying to minimise Mean Time Between Failures.

# [Linux](/linux/)

- Wrote my first [bash script](/bash-automation/)!

# [Architecture](/architecture/)

- [DDD](/dddd/)
- [Various AWS bits](/aws/), preparing for Solutions Architecture exam

# Organisation Design

It seems this topic is pretty closely related to software architecture.

- [Reckoning with Conway's Law](/conways-law/) - thoughtworks podcast featuring James Lewis & Martin Fowler
- Other Dan North & James Lewis stuff
- [ING bank](/ing-bank/) - A Case study of ING bank and their experiments with team topologies.
- [Patterns of effective teams](/patterns-of-effective-teams/) - A talk by Dan North about ways you can organise your teams for success.

### Organisation Design Books

- [Team topologies](/team-topologies/)
- [Accelerate](/accelerate/) - referenced heavily in the conference circle, podcasts, articles, other books. This book is a must read
- [Working Backwards](https://www.workingbackwards.com/) - Current read

# Cognitive Load

A topic related to organisation design & architecture. Learning about [cognitive load theory](/cognitive-load-theory/) was pretty insightful, applicable to many areas of life.

This idea was introduced to me by [James Lewis](/tt-jl/) while discussing his experience & research on Team Topologies, software architecture, & complexity science.

# [UX](/ux/)

User Experience continues to be a topic of interest. 2022 observations focused on the UX music apps mostly.

I wrote about [dark patterns](/dark-patterns/)
...
- [Engineering Management for the rest of us](/engineering-management/) - this book was a lovely read
- [Managing client relationships](/client-relationships/) (as a consultant)

# Productivity

- [Saying no, increased focus](https://fs.blog/focus-to-win/), reduced involvement in multiple projects in fly at once.
- [Applying shape up](/applying-shape-up/)
- [How to read](/reading/)
