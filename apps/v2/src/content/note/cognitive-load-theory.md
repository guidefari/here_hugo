...
tags: [psychology, learning, dx, software-design, process, complexity]
images: ['https://og.guidefari.com/og-image?title=Cognitive%20Load%20Theory']
...
- [Dan North](/patterns-of-effective-teams/) speaks about this in [Software that fits in your head](https://youtu.be/4Y0tOi7QWqM).

<div class="relative w-full my-6 overflow-hidden border rounded-sm border-text/20 bg-black" style="aspect-ratio: 16 / 9;"><iframe class="absolute inset-0 w-full h-full" src="https://www.youtube.com/embed/4Y0tOi7QWqM" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
...
- [Dan North has some good tips on how to handle intrinsic load](/patterns-of-effective-teams/), Dreyfus Squared comes to mind.
