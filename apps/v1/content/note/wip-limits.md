...
- WIP limits are a way to "drive process (improvement) and increase throughput". I've heard other authors ([Team Topologies](/tt-jl/)) refer to this as "optimising for flow of value through the system"
- Can also be thought of as a way to identify bottlenecks in your system
- Optimising for flow of value works best in an environment that focuses on [team-first thinking](/team-topologies-team-first-thinking/), as opposed to optimising individuals' output.
...
- [My barebones notes on the rest of the book](/accelerate/)
